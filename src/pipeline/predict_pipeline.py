...
class CustomData:
    ...
    def get_data_as_dataframe(self):
      ...
      Args:
        headline (str): headline to be preprocessed
      
      Returns:
        input_df (pd.DataFrame): dataframe with preprocessed headline
      '''
      try:
...
class PredictPipeline:
  ...
  def predict(self, features: pd.DataFrame):
      '''
      Predicts the category of the given headline using the trained model.
      
      Args:
          features (pd.DataFrame): A DataFrame containing the features of the headline.
          
      Returns:
          label (str): The predicted category of the headline.
